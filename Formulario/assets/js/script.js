...
function valiPassword(passwordValue){
    if (passwordValue === "")
...
function validPasswordConfirmation(passwordConfirmationValue, passwordValue){
...
function checkInputs(){
    ...
    valiPassword(passwordValue);
    validPasswordConfirmation(passwordConfirmationValue, passwordValue);
